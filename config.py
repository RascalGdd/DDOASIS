...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--batch_size_supervised', type=int, default=1, help='input supervised dataset batch size')
    parser.add_argument('--batch_size_train', type=int, default=1, help='input train dataset batch size')
